...
parser.add_argument('-datadir', help = 'Absolute path to the directory that holds the dataset', \
	type = str, default = '/home/cccjaccck/workspace/capstone/dataset/dataset')
...
parser.add_argument('-imageWidth', help = 'Width of the input image', type = int, default = 752//4)
parser.add_argument('-imageHeight', help = 'Height of the input image', type = int, default = 480//4)
...
parser.add_argument('-numLSTMCells', help = 'Number of LSTMCells', type = int, default = 2)
